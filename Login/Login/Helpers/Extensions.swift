...
extension UIButton{
    ...
    func activated(){
        ...
        self.backgroundColor = clr_blue
        self.layer.borderColor = clr_blue.cgColor
    }
    
    func deactivated(){
        
        self.backgroundColor = clr_highlightedBtn
        self.layer.borderColor = clr_highlightedBtn.cgColor
    }
