...
func font_SFProBold(size : CGFloat) -> UIFont{
    ...
    return UIFont(name: "Graphie-Bold", size: size * stringMultiplier)!
    
}

func font_SFProRegular(size : CGFloat) -> UIFont{
    
    return UIFont(name: "Graphie-Regular", size: size * stringMultiplier)!
    
}

func font_SFProSemiBold(size : CGFloat) -> UIFont{
    
    return UIFont(name: "Graphie-Semibold", size: size * stringMultiplier)!
    
}

func font_SFProMedium(size : CGFloat) -> UIFont{
    
    return UIFont(name: "Graphie-Book", size: size * stringMultiplier)!
